...
public class MyTest {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("lian")
                //D:\Codes\family\family_service\src\main\java
                .setOutputDir("D:\\Codes\\family\\family_service\\src\\main\\java")//设置输出路径
        ...
        packageConfig.setParent("com.li").setMapper("mapper")
